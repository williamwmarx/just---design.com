    ...
    <div className="root">
      ...
      <div className="text-content">
        <h3>Graphic Design Elements</h3>
          <p>Typefaces:</p>
          <ul>
            <li><a rel="noreferrer" target="_blank" href="https://www.vocaltype.co/history-of/carrie">Carrie</a> c/o <a rel="noreferrer" target="_blank" href="https://www.vocaltype.co/">Vocal Type</a></li>
