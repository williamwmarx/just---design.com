...
export default class Link extends React.Component {
    ...
    render() {
        ...
        let authornohover = nohover;
        let authorhover = `linear-gradient(90deg, rgba($rgba(${author_color2[0]}, ${author_color2[1]}, ${author_color2[2]}, ${hover_transparency}), rgba(${author_color2[0]}, ${author_color2[1]}, ${author_color2[2]}, ${hover_transparency})`;
        ...
        function authorUnhoverUnderlineColor(e) {e.target.style.backgroundImage = authornohover;}
        ...
        if (this.props.new_tab !== false) {
            ...
            else link = <a rel="noreferrer" target="_blank" style={author_styles} onMouseEnter={authorHoverUnderlineColor} onMouseLeave={authorUnhoverUnderlineColor} href={this.state.href}>{this.props.children}</a>;
        } else {
